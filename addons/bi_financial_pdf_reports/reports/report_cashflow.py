    ...
    def _compute_report_balance(self, reports):
        ...
        for report in reports:
            ...
            if report.type == 'accounts':
                ...
                cash_in_operation = self.env.ref('bi_financial_pdf_reports.cash_in_from_operation0')
                cash_out_operation = self.env.ref('bi_financial_pdf_reports.cash_out_operation1')
                cash_in_financial = self.env.ref('bi_financial_pdf_reports.cash_in_financial0')
                cash_out_financial = self.env.ref('bi_financial_pdf_reports.cash_out_financial1')
                cash_in_investing = self.env.ref('bi_financial_pdf_reports.cash_in_investing0')
                cash_out_investing = self.env.ref('bi_financial_pdf_reports.cash_out_investing1')
...
class CashFlow(models.Model):
    ...
    def get_cash_flow_ids(self):
        cash_flow_id = self.env.ref('bi_financial_pdf_reports.account_financial_report_cash_flow0')
        if cash_flow_id:
